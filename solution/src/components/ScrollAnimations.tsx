...
export function ScrollImage({
  ...
  if (isVertical) {
    ...
    overlayAlpha =
      progress < 0.5 ? overlayOpacity + (0.5 - progress) * 0.15 : overlayOpacity + (progress - 0.5) * 0.15;
  }
    ...
    <div ref={ref} className={`relative overflow-hidden ${className}`}>
      <div
        ...
        style={{
          ...
          transition: isVertical ? `transform 1.2s ${EASE.standard}` : `transform ${T_MEDIUM}, clip-path ${T_MEDIUM}`,
        }}
      >
...
export function HeroExpandingImage({ src, scrollX, className = "", isVertical = false }: HeroExpandingImageProps) {
  const ref = useRef<HTMLDivElement>(null);
    ...
    <div ref={ref} className={`relative overflow-hidden ${className}`}>
      <div
        ...
        style={{
          ...
          transition: isVerticalMode ? `transform 1.2s ${EASE.standard}` : `transform 2.4s ${EASE.standard}`,
        }}
      >
